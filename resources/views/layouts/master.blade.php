...
<!-- Libs JS -->
<script src="{{ asset(config('app.theme.path').'dist/libs/nouislider/dist/nouislider.min.js?1674944402') }}" defer></script>
<script src="{{ asset(config('app.theme.path').'dist/libs/litepicker/dist/litepicker.js?1674944402') }}" defer></script>
<script src="{{ asset(config('app.theme.path').'dist/libs/tom-select/dist/js/tom-select.base.min.js?1674944402') }}" defer></script>
<!-- Tabler Core -->
